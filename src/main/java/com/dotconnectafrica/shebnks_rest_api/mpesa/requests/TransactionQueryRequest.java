 ...
 */
package com.dotconnectafrica.shebnks_rest_api.mpesa.requests;
...
@Setter
@Builder
public final class TransactionQueryRequest {
    /**
    ...
    /**
     * This is the M-Pesa PaymentRequest ID of the transaction which you wish to enquire.
     */
    @SerializedName("TransactionID")
    String transactionID;

    /**
     * This is the shortcode of the organization / MSISDN sending the transaction.
     */
